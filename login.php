...
if(isset($_POST["signin"])){
  $sql = "SELECT user_id,username,password FROM user WHERE username = :un OR email_id = :un";
    ...
    <div class="container-fluid login-header d-flex flex-column align-items-center">
        <div class="row d-flex flex-column justify-content-center form-container align-items-center">
            <div class="row d-flex login-header-text text-center ">
                <div class="col-12">
                    <h1>Sign In</h1>
                    <h5>Vibe with the best Music community</h2>
                      <?php
            ...
            <div class="row d-flex forgot-password-text text-center">
                <div class="col-12">
            ...
            <div class="row d-flex text-center">
                <div class="col create-account">
                    <h6>Don't have an Account? <a class="forgot-password" href="./signup.php">Create one</a></h6>
